...
require "pluginsConfig.file-icons.lua"

require "misc-utils.lua"
require "pluginsConfig.bufferline.lua"
require "pluginsConfig.statusline.lua"

require("colorizer").setup()
require("neoscroll").setup() -- smooth scroll

-- lsp
require "pluginsConfig.lsp.lua"
require "compe.lua"
...
require("pluginsConfig.treesitter.lua")
...
require "pluginsConfig.telescope.lua"
require "pluginsConfig.nvimTree.lua"
